...
const alt_watt_contract = new ethers.Contract(alt_wattToken.address,alt_wattToken.abi,alt_provider)
const alt_mininggame = new ethers.Contract(alt_miningGame.address,alt_miningGame.abi, alt_provider)
